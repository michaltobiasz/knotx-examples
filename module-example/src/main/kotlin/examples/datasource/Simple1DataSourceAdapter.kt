...
class Simple1DataSourceAdapter : AbstractVerticle() {

    private companion object {
        val LOGGER: Logger = LoggerFactory.getLogger(Simple1DataSourceAdapter::class.java)
    }
    ...
    override fun start() {
        ...
        consumer = serviceBinder
            ...
            .register(DataSourceAdapterProxy::class.java, Simple1DataSourceAdapterProxy())
    }
